...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    add_score = 3 * abs(player_score % 10 - opponent_score // 10 % 10)
    if add_score == 0:
        return 1
    else:
        return add_score
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    i = 2
    ans = 1
    max_score = make_averaged(roll_dice, samples_count)(1, dice)
    while i <= 10:
        temp_score = make_averaged(roll_dice, samples_count)(i, dice)
