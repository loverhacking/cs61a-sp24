...
def make_averaged(original_function, total_samples=1000):
    ...
    def averaged_dice(*args):
        score = [original_function(*args) for i in range(total_samples)]
        return sum(score) / total_samples
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    score_record = [make_averaged(roll_dice, total_samples)(i, dice) for i in range(1, 11)]
    return score_record.index(max(score_record)) + 1
    # END PROBLEM 9
