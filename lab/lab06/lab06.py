...
def make_change(amount, coins):
    ...
    without_smallest = make_change(amount, rest)
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        desire_change_coins = make_change(coin, self.coins)

        if desire_change_coins:
            for i in desire_change_coins:
                if self.coins[i] == 1:
                    self.coins.pop(i)
                else:
                    self.coins[i] -= 1
